...
public:
  ...
  FindOrCreate (ns3::Ptr<const ns3::ndn::Name> name);
...
private:
  ...
  Ns3NameInfo (ns3::Ptr<const ns3::ndn::Name> name);
  
  ns3::Ptr<const ns3::ndn::Name> m_name;
};

Digest &
operator << (Digest &, const ns3::ndn::Name &name);
